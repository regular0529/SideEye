...
URL: [https://wiki.seeedstudio.com/xiao_espnow/](https://wiki.seeedstudio.com/xiao_espnow/)

![]([https://files.seeedstudio.com/wiki/SeeedStudio-XIAO-ESP32S3/img/126.png](https://files.seeedstudio.com/wiki/SeeedStudio-XIAO-ESP32S3/img/126.png))
...
- [Seeed Studio XIAO ESP32S3]([https://wiki.seeedstudio.com/xiao_esp32s3_getting_started/](https://wiki.seeedstudio.com/xiao_esp32s3_getting_started/))

- [Seeed Studio XIAO ESP32C3]([https://wiki.seeedstudio.com/xiao_esp32c3_getting_started/](https://wiki.seeedstudio.com/xiao_esp32c3_getting_started/))

- [Seeed Studio XIAO ESP32C6]([https://wiki.seeedstudio.com/xiao_esp32c6_getting_started/](https://wiki.seeedstudio.com/xiao_esp32c6_getting_started/))

## What is ESP-NOW protocol?

The official definiton provided : ESP-NOW is a wireless communication protocol defined by espressif that enables direct, fast, and low-power control of smart devices without the need for a [router.It](http://router.It) can coexist with Wi Fi and Bluetooth LE, supporting multiple series of SoCs such as Lexin ESP8266, ESP32, ESP32-S, and ESP32-C. ESP-NOW is widely used in fields such as smart home appliances, remote control, and sensors.
...
| ![]([https://files.seeedstudio.com/wiki/XIAO_WiFi/board-pic.png](https://files.seeedstudio.com/wiki/XIAO_WiFi/board-pic.png)) | ![]([https://files.seeedstudio.com/wiki/SeeedStudio-XIAO-ESP32S3/img/xiaoesp32s3.jpg](https://files.seeedstudio.com/wiki/SeeedStudio-XIAO-ESP32S3/img/xiaoesp32s3.jpg)) | ![]([https://files.seeedstudio.com/wiki/SeeedStudio-XIAO-ESP32C6/img/xiaoc6.jpg](https://files.seeedstudio.com/wiki/SeeedStudio-XIAO-ESP32C6/img/xiaoc6.jpg)) 

| [**Get One Now 🖱️**]([https://www.seeedstudio.com/Seeed-XIAO-ESP32C3-p-5431.html](https://www.seeedstudio.com/Seeed-XIAO-ESP32C3-p-5431.html)) | [**Get One Now 🖱️**]([https://www.seeedstudio.com/XIAO-ESP32S3-p-5627.html](https://www.seeedstudio.com/XIAO-ESP32S3-p-5627.html)) | [**Get One Now 🖱️**]([https://www.seeedstudio.com/Seeed-Studio-XIAO-ESP32C6-p-5884.html](https://www.seeedstudio.com/Seeed-Studio-XIAO-ESP32C6-p-5884.html)) 
...
void Association_ReceiverXIAOC3_peer(){
  ...
  [peerInfo.channel](http://peerInfo.channel) = ESPNOW_WIFI_CHANNEL;
...
void Association_ReceiverXIAOC6_peer(){
  ...
  [peerInfo1.channel](http://peerInfo1.channel) = ESPNOW_WIFI_CHANNEL;
...
void Association_SenderXIAOS3_peer(){
  ...
  peerInfo_[sender.channel](http://sender.channel) = ESPNOW_WIFI_CHANNEL;
...
![]([https://files.seeedstudio.com/wiki/SeeedStudio-XIAO-ESP32S3/img/121.png](https://files.seeedstudio.com/wiki/SeeedStudio-XIAO-ESP32S3/img/121.png))

#### Receiver XIAO ESP32C3 Result

![]([https://files.seeedstudio.com/wiki/SeeedStudio-XIAO-ESP32S3/img/122.png](https://files.seeedstudio.com/wiki/SeeedStudio-XIAO-ESP32S3/img/122.png))

#### Receiver XIAO ESP32C6 Result

![]([https://files.seeedstudio.com/wiki/SeeedStudio-XIAO-ESP32S3/img/123.png](https://files.seeedstudio.com/wiki/SeeedStudio-XIAO-ESP32S3/img/123.png))
...
- **[Espressif Official Documents]**[ESPRESSIF ESP-IDF ESP-NOW]([https://docs.espressif.com/projects/esp-idf/zh_CN/stable/esp32/api-reference/network/esp_now.html?highlight=espnow#esp-now](https://docs.espressif.com/projects/esp-idf/zh_CN/stable/esp32/api-reference/network/esp_now.html?highlight=espnow#esp-now))
